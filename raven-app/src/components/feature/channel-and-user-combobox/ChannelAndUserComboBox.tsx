...
interface ChannelAndUserComboBoxProps extends BoxProps {
  label?: string,
  selectedOptions: (UserFields | ChannelListItem)[],
  setSelectedOptions: (options: (UserFields | ChannelListItem)[]) => void
}

const ChannelAndUserComboBox = ({ selectedOptions, setSelectedOptions, label = 'Select Users / Channels', ...props }: ChannelAndUserComboBoxProps) => {
...
export default ChannelAndUserComboBox